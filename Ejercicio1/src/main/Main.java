...
/**
 * Clase Main del programa que se encarga de gestionar la I/O del gestor
 * 
 * @see Critica
 * @see GestorCriticas
 * @see Espectador
...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Primero exportamos al fichero de propiedades las rutas virtuales donde voy a
		// almacenar mis ficheros

		// En caso de querer exportar el fichero de propiedades previamente para
		// especificar la ruta de los datos, descomentar
		// la sección

		/*
		 * try { GestorCriticas.exportarFicheroPropiedades("./data/datosUsuarios.txt",
		 * "./data/datosCriticas.txt"); } catch (FileNotFoundException error) {
		 * System.err.
		 * print("La ruta indicada del fichero de propiedades no ha sido encontrada\n\n"
		 * );
		 * 
		 * systemPause(); System.exit(1);
		 * 
