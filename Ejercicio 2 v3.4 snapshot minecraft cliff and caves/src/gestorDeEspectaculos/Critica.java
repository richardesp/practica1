...
public class Critica {
	 ...
	 * @author Ricardo Espantaleón Pérez
	 */
	public Critica(String titulo, float puntuacion, String comentario, Espectador autor,String tituloEspectaculo) {
	...
	/**
	 * Función que devuelve el espectaculo asignado a la crítica
	 * 
	 * @param nickAutor Cadena la cual contiene el nuevo nickName del autor
	 * 
	 * @see Espectador
